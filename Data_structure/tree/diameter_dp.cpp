...
// T.C         : O(n) for each node of the tree we are calculating height of that node, which is a O(1) operation using DP. 
// A.S         : O()
//============================================================================
...
class Tree{
    ...
    public:
        Tree(int valueOfNode){
            ...
            this->left=NULL;
            this->right=NULL;
            // -1 indecates that hight for this node is not calculated Yet!
            this->height = -1;
        }
        /**
        ...
        int getHeight(Tree *root){
            ...
            // if height is already computed then, just return the height
            if(root->height != -1){
                return root->height;
            }
