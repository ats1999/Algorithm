...
// Description : Implement N-Queen problem, with backtracking to print multiple instances of placement.
// Same as single instance, return false when queens are processed. 
// T.C         : O()
// A.S         : O()
//============================================================================
#include<bits/stdc++.h>
 ...
 * @param n number of queens
 * @return all the possibility of placing the queens
 */
